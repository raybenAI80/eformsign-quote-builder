...
// NanumSquare CDN URLs
const FONT_URLS = {
    regular: 'https://cdn.jsdelivr.net/gh/innks/NanumSquareRound@master/NanumSquareRoundR.ttf',
    bold: 'https://cdn.jsdelivr.net/gh/innks/NanumSquareRound@master/NanumSquareRoundB.ttf',
};
...
export function registerNanumSquareFont(pdf: jsPDF): void {
    ...
    // Regular 폰트 등록
    pdf.addFileToVFS('NanumSquareRound-Regular.ttf', fontCache.regular);
    pdf.addFont('NanumSquareRound-Regular.ttf', 'NanumSquare', 'normal');

    // Bold 폰트 등록
    pdf.addFileToVFS('NanumSquareRound-Bold.ttf', fontCache.bold);
    pdf.addFont('NanumSquareRound-Bold.ttf', 'NanumSquare', 'bold');
}
