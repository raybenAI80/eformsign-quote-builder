...
> = {
  ...
  creditDoc: {
    ...
    factory: () => ({
      ...
      unitPrice: 800,
      discountPct: 0,
      notes: '10건 이하 1,000원/건, 11건 이상 800원/건 (최대 3,000건)',
    }),
    style: 'bg-emerald-50 text-emerald-600 border border-emerald-200 hover:bg-emerald-100',
  },
  subscriptionBiz: {
    label: '구독형 Business',
    section: 'SaaS',
    factory: () => ({
      ...
      unitPrice: 40000,
      discountPct: 0,
      notes: '멤버 무제한, 문서 100건/월 포함 (초과 시 600원/건)\n카카오톡 알림톡/SMS 알림 무제한\n템플릿 무제한\n일괄작성·대량전송\nURL로 문서 작성\n그룹 및 권한 설정\nAPI/Webhook 제공\n프리미엄 서비스 제공',
    }),
    style: 'bg-violet-50 text-violet-600 border border-violet-200 hover:bg-violet-100',
  },
  subscriptionPersonal: {
    ...
    factory: () => ({
      ...
      unitPrice: 10000,
      discountPct: 0,
      notes: '멤버 1명, 문서 50건/월 포함 (초과 시 1,000원/건)\n카카오톡 알림톡/SMS 알림 무제한\n템플릿 무제한\n일괄작성·대량전송\nURL로 문서 작성',
    }),
    style: 'bg-violet-50 text-violet-600 border border-violet-200 hover:bg-violet-100',
  },
  credit100k: {
