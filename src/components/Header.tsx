...
export const Header: React.FC<HeaderProps> = ({
  ...
  const showPreviewText = headerWidth > 650; // Increased breakpoint
  ...
  return (
    ...
    >
      {/* Single Row: Branding + User + Actions */}
      <div className="flex h-14 w-full items-center justify-between px-3 sm:px-4 gap-2 overflow-hidden">
        ...
        <div className="flex items-center gap-2 shrink-0">
          {user && (
            <div className="hidden md:flex items-center gap-2 mr-2 px-2 py-1 bg-gray-50 rounded-full border border-gray-100">
              ...
              <button
                onClick={signOut}
                className="ml-1 text-xs text-gray-400 hover:text-gray-600 hover:underline"
              >
                로그아웃
              </button>
            </div>
